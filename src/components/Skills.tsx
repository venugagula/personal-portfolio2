  ...
  return (
    <section className="py-12 bg-muted/30">
      <div className="container mx-auto px-6">
        ...
        <Card className="border-0 shadow-card rounded-lg">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-accent text-accent-foreground">
                <Settings className="w-4 h-4" />
              </div>
              <CardTitle className="text-lg font-bold">Education & Relevant Coursework</CardTitle>
            </div>
            <div className="space-y-1">
              <h3 className="text-base font-semibold text-primary">Master's in Computer/Information Technology Administration and Management</h3>
              <p className="text-muted-foreground text-sm">Lindsey Wilson College • Aug. 2023 – May 2025 • Columbia, Kentucky</p>
            </div>
          </CardHeader>
            ...
            <div className="flex flex-wrap gap-1.5">
              {coursework.map((course, i) => (
                <Badge 
                  key={i} 
                  variant="outline" 
                  className="border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-colors text-xs"
                >
                  {course}
                </Badge>
              ))}
